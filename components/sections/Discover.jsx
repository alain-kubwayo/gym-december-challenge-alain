    ...
    return ( 
        <Wrapper>
            <section className="relative mt-12">
                ...
                <div className="flex flex-col w-74.25 px-2 pb-2 border absolute bg-white mt-8">
                ...
                <div className="flex gap-x-[3.5rem] justify-end">
                    <div>
                        <Image src="/discover.webp" height={445.79} width={688} alt="Image" />
                    </div>
                    <div className="my-auto w-[419px] space-y-[1.5rem]">
                        ...
                        <Button style="text-primary-300 border-primary-300 border" description="Learn more" />
                    </div>
                </div>
            </section>
        </Wrapper>
