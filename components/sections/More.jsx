...
const More = () => {
    return ( 
        <Wrapper>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-y-[2.5rem]  md:gap-y-0 md:gap-x-[9rem] mb-[2.5rem] mt-24">
                ...
                <Link href="" className="flex-col block w-full space-y-3 text-black md:flex md:justify-between hover:text-primary-300">
                    <div>
                        <img src="/more-img-2.jpeg"  alt="Image" className="h-full w-full md:w-[368px] md:h-[256px]" />
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 md:gap-x-[9rem] gap-y-[2.5rem]">
